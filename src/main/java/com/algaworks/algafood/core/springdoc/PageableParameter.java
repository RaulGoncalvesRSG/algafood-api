...
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE})         //Pode ser combinada com method ou outra anotation
...
public @interface PageableParameter {           //Anotação para paginação (PagedModel)
}
