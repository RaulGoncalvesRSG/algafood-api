...
import com.algaworks.algafood.core.security.authorizationserver.OAuth2AuthorizationQueryService;
...
public class AuthorizedClientsController {
    ...
    private static final String CLIENTE_NAO_ENCONTRADO = "Cliente %s não encontrado";

    @GetMapping("/oauth2/authorized-clients")       //A URl possui qualquer path, desde q o client esteja logado para acessá-la
